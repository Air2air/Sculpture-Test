...
static int Run_A_(struct pt * pt) {
  static unsigned long PWM_High = SEC_A_PWM_HIGH;
  static unsigned long Leg = SEC_A;
  static unsigned long Wait = SEC_A_WAIT;
  static unsigned long Duration = SEC_A_DURATION;
  static unsigned long Ramp_Increment = SEC_A_PWM_INCREMENT;
